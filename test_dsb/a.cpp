...
/* PR FUNCTIONS, AUTO GENERATED CODE, MODIFY IF YOU KNOW WHAT YOU WANT */
    double pr_nginx_web_server(TaskDescription* td) {
      ...
      {
case RequestType::COMPOSE:
    if(td->nbHops == 1){XBT_DEBUG("Entered cost Function for COMPOSE"); return 1876000;}
...
return -1;
    ...
    double pr_media_service(TaskDescription* td) {
      ...
      {
case RequestType::COMPOSE:
    if(td->nbHops == 2){XBT_DEBUG("Entered cost Function for COMPOSE"); return 415000;}
...
return -1;
    ...
    double pr_compose_post_service(TaskDescription* td) {
      ...
      {
case RequestType::COMPOSE:
    if(td->nbHops == 3){XBT_DEBUG("Entered cost Function for COMPOSE"); return 770000;}

    if(td->nbHops == 6){XBT_DEBUG("Entered cost Function for COMPOSE"); return 579000;}

    if(td->nbHops == 10){XBT_DEBUG("Entered cost Function for COMPOSE"); return 652000;}

    if(td->nbHops == 13){XBT_DEBUG("Entered cost Function for COMPOSE"); return 938000;}

    if(td->nbHops == 15){XBT_DEBUG("Entered cost Function for COMPOSE"); return 1860000;}
    ...
    if(td->nbHops == 25){XBT_DEBUG("Entered cost Function for COMPOSE"); return 629000;}
...
return -1;
    ...
    double pr_user_service(TaskDescription* td) {
      ...
      {
case RequestType::COMPOSE:
    if(td->nbHops == 5){XBT_DEBUG("Entered cost Function for COMPOSE"); return 334000;}
...
return -1;
    ...
    double pr_text_service(TaskDescription* td) {
      ...
      {
case RequestType::COMPOSE:
    if(td->nbHops == 8){XBT_DEBUG("Entered cost Function for COMPOSE"); return 1578000;}
...
return -1;
    ...
    double pr_url_shorten_service(TaskDescription* td) {
      ...
      {
case RequestType::COMPOSE:
    if(td->nbHops == 9){XBT_DEBUG("Entered cost Function for COMPOSE"); return 837000;}
...
return -1;
    ...
    double pr_user_mention_service(TaskDescription* td) {
      ...
      {
case RequestType::COMPOSE:
    if(td->nbHops == 12){XBT_DEBUG("Entered cost Function for COMPOSE"); return 1934000;}
...
return -1;
    ...
    double pr_post_storage_service(TaskDescription* td) {
      ...
      {
case RequestType::COMPOSE:
    if(td->nbHops == 16){XBT_DEBUG("Entered cost Function for COMPOSE"); return 976000;}
...
return -1;
    ...
    double pr_user_timeline_service(TaskDescription* td) {
      ...
      {
case RequestType::COMPOSE:
    if(td->nbHops == 18){XBT_DEBUG("Entered cost Function for COMPOSE"); return 3950000;}
...
return -1;
    ...
    double pr_write_home_timeline_service(TaskDescription* td) {
      ...
      {
case RequestType::COMPOSE:
    if(td->nbHops == 20){XBT_DEBUG("Entered cost Function for COMPOSE"); return 447000;}

    if(td->nbHops == 22){XBT_DEBUG("Entered cost Function for COMPOSE"); return 47000;}
...
return -1;
    ...
    double pr_social_graph_service(TaskDescription* td) {
      ...
      {
case RequestType::COMPOSE:
    if(td->nbHops == 21){XBT_DEBUG("Entered cost Function for COMPOSE"); return 1756000;}
...
return -1;
    ...
    double pr_unique_id_service(TaskDescription* td) {
      ...
      {
case RequestType::COMPOSE:
    if(td->nbHops == 24){XBT_DEBUG("Entered cost Function for COMPOSE"); return 377000;}
